...
1. You will be asked to enter the filename of the concerned input file. Please make sure you enter correct filename with .txt extension. It is IMPORTANT to write .txt at the end.

2. Based on the text file name entered, the compiler will run the code and display safe-sequence (if any), and Will generate thread for each process to simulate the Safe-Sequence generated.